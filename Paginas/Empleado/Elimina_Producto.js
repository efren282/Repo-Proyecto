...
class Elimina_Producto extends React.Component {
  state = {
    id: '',
  };
  ...
  if (xhttp.readyState == 4 && xhttp.status == 200) {
    if(xhttp.responseText == "0"){
        ...
        this.props.navigation.navigate('Baja_Producto', {datos: xhttp.responseText});
        console.log(xhttp.responseText)
      }
  }
};
xhttp.open("GET", 'https://mppag.000webhostapp.com/Seminario_Bases_Datos/Empleado/elimina_producto.php?id='+this.state.id, true);
xhttp.send();
  }
  }
...
export default Elimina_Producto;
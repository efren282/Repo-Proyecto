...
export default class Mostrar_Empleados extends Component {
  constructor() {
    super();
    this.state = {
      dataSource: [],
  ...
  componentDidMount() {
    const url =
      'https://mppag.000webhostapp.com/Seminario_Bases_Datos/Gerente/mostrar_empleados.php';
    fetch(url)
      .then((response) => response.json())
      .then((responseJson) => {
        this.setState({
          isLoading: false,
          dataSource: responseJson.empleados
        });
      })
      .catch((error) => {
        console.log(error);

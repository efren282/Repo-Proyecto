...
class Baja_Sistema extends React.Component {
  constructor(props) {
    super(props);
  ...
  xhttp.open("GET", 'https://mppag.000webhostapp.com/Seminario_Bases_Datos/Gerente/baja_sistema.php?id='+this.state.id, true);
  xhttp.send();
}
